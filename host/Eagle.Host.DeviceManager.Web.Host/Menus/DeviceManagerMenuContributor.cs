...
namespace Eagle.Host.DeviceManager.Menus
{
    public class DeviceManagerWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public DeviceManagerWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<DeviceManagerResource>();
